...
const fetch_user_detail=()=>{
    ...
    .then((Response)=>{
        ...
        setbank(Response[0]['bank_account'])
...
const update_detail=()=>{
    console.log(this.state.update_phone)
}
   ...
   <View>
        ...
        <View style={styles.action}>
          ...
          <TextInput
            ...
            onChangeText={(text)=>{this.setStates({update_phone:text})}}
            style={[
              styles.textInput,
              {
                color: colors.text,
         ...
         <View style={styles.action}>
          ...
          <TextInput
            ...
            placeholderTextColor="#666666"
            keyboardType="number-pad"
            onChangeText={update_bank=>onChangeText(update_bank)}
            style={[
              styles.textInput,
              {
                color: colors.text,
        ...
        <View style={styles.action}>
          ...
          defaultValue={password}
            ...
            placeholderTextColor="#666666"
            onChangeText={update_password=>onChangeText(update_password)}
            mode="outlined"
            style={[
              styles.textInput,
              {
