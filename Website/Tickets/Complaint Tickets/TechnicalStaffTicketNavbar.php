...
<div class="w3-bar w3-blue w3-card">
	...
	<div class="navbar-links" style="justify-content: space-between;">
		<div style="flex-grow: 0;">
			<a href="../../Admin homepage/adminHomePage.php" class="w3-bar-item w3-button w3-padding-large">Staff</a>
		</div>
		<div style="flex-grow: 1; display: flex; justify-content: center;">
			<a href="complaintTicketHomepage.php" class="w3-bar-item w3-button w3-padding-large active">Assigned Tickets</a>
			...
			<a href="waterusage.php" class="w3-bar-item w3-button w3-padding-large">Water usage</a>
		</div>
