	...
	<div class="container">
		<div class="rectangle-box">
		    <h3 class="heading-gap">Edit Water Rate</h3>
				<table align="center">
				<tr>
					<td><input type="text" placeholder="Current Water Rate: " name="?"></td>
				</tr>
				<tr>
					<td><input type="text" placeholder="New Water Rate: " name="?"></td>
				</tr>
				<tr>
					<td><button type="submit" style="border-radius: 5px">Update</button></td>
				</tr>
				<tr>
