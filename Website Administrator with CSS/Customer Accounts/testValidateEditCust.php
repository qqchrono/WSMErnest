...
<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		// Form validation
		if(empty($customerName) || empty($address) || empty($email) || empty($password)) {
			...
			<table align="center">
				<tr>
					<td>
						...
						<input type="text" id="customerID" name="customerID" value="<?php echo $customerID ?>" readonly>
					</td>
				</tr>
				<tr>
					<td>
						<label for="customerName">Customer Name:</label>
						<input type="text" id="customerName" placeholder="Customer Name" name="customerName" value="<?php echo $customerName ?>">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						...
						<input type="text" id="address" placeholder="Address" name="address" value="<?php echo $address ?>">
					</td>
				</tr>
				<tr>
					<td>
