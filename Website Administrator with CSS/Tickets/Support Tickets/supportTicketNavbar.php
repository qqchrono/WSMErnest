		...
		<div style="flex-grow: 1; display: flex; justify-content: center;">
			...
			<div class="w3-dropdown-hover w3-hide-small">
				...
				<div class="w3-dropdown-content w3-bar-block w3-card-4">
					<a href="../Complaint Tickets/complaintTicketHomepage.php" class="w3-bar-item w3-button">Complaint Tickets</a>
					<a href="../Support Tickets/supportTicketHomepage.php" class="w3-bar-item w3-button active">Support Tickets</a>
				</div>
			</div>
